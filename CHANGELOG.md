...
- Added a feature-gated, pre-Tauri performance harness with deterministic synthetic datasets, production-path scanner/database/playback/media scenarios, strict JSON and Markdown reports, fail-closed comparison gates, and a small 120-item CI contract. Standard and Stress results are not claimed until those workflows are explicitly run.
