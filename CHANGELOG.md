...
- Recorded the first comparable, untouched local Standard baseline for the 10,000-item performance dataset and selected `scan.full` for the next evidence-led optimization. This is machine-specific evidence; no production optimization or Stress result is claimed yet.
